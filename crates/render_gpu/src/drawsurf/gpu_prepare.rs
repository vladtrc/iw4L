use render_frame::{WgpuBindLayoutEntry, WgpuPassLayout};
use render_material::{
    ConstantBinding, ConstantSource, ExecutablePassView, PackedCodeConstantLane, PackedLocalBanks,
    PortId, RuntimeShaderStage,
};
...
pub(super) fn overlay_lane_bytes(
...
pub(super) fn require_abi_rows_with_lanes(
    stage: RuntimeShaderStage,
...
pub(super) fn pack_code_on_seed(
...
) -> (Vec<WgpuBindLayoutEntry>, Vec<WgpuBindLayoutEntry>) {
