...
/// One line per load of what this transition built or handed over new, beside
/// what it took from an earlier load. Read two identical transitions side by
/// side before choosing what to make resident.
fn log_load_ledger(
    job: &WorldSpawnJob,
