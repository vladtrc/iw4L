...
pub use glass::{
    ...
    FxGlassSlabVert, fx_glass_alloc_piece, fx_glass_ballistic_origin, fx_glass_clear_in_use,
    ...
    fx_glass_state_hole_count, fx_glass_state_init_index, fx_glass_state_set_flags,
...
pub use glass_shatter::{
    ...
    FX_GLASS_SHATTER_BRANCH_SCALE, FX_GLASS_SHATTER_FX_PER_FRAME, FX_GLASS_SHATTER_TWO_PI,
    FX_GLASS_SPLIT_MAX_CHILDREN, FX_GLASS_SPLIT_MAX_VERTS, FX_GLASS_SPLIT_OP_CAP,
    FX_GLASS_SPLIT_QUEUE_CAP, FX_GLASS_STATE_FLAG_CHILD_CLEAR, FX_GLASS_STATE_FLAG_SHATTERED,
    FxGlassRadialSplit, FxGlassSplitLoop, fx_glass_centroid, fx_glass_child_support,
    fx_glass_chord_split, fx_glass_clamp_impact, fx_glass_cross3, fx_glass_fringe_cap,
    fx_glass_fringe_prune_knock_order, fx_glass_interior_angle_step,
...
pub use trail::{
    ...
    fx_pack_code_mesh_vertex, fx_pack_code_mesh_vertex_signed, fx_trail_compress_basis,
    fx_trail_compress_char, fx_trail_compute_u, fx_trail_emit_index_quad,
    fx_trail_emit_segment_vert, fx_trail_emit_segment_verts, fx_trail_index_quad_tris,
    fx_trail_pack_normal, fx_trail_pack_texcoord, fx_trail_uncompress_basis,
};
